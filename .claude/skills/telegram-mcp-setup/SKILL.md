...
Даёт Claude доступ к твоим чатам: читать историю, искать сообщения, готовить черновики ответов — прямо из Claude Code. Полезно, когда контекст для задачи (созвон, договорённость, файл) лежит в рабочей Telegram-переписке, а не в самом Claude Code.
